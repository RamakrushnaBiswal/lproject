    ...
    <div class="navbar">
      <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="2SOFA.html">2 Seater Sofa</a>
            <a href="1SEAT.html">Single Seater Sofa</a>
...
<main>
    ...
    <div class="container">
        <?php
        $query = "SELECT * FROM `threeshofa` ORDER BY id ASC";
        ...
        if(mysqli_num_rows($result)>0){
            while($row = mysqli_fetch_array($result)){
                ?>
                <div class="product">
                    <form action="2SOFA.php?action=add&id=<?php echo $row["id"]?>" method="post">
                    <div class="product">
